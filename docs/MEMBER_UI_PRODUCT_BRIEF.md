...
- [ ] Use the canonical Member purple-blue accent token from `MEMBER_COLOR_ICON_CONTRACT.md`; gold is reserved for meaningful prize/reward emphasis, not as a second global accent.

...
- [`operations/support-runbook.md`](operations/support-runbook.md), [`operations/verification-commands.md`](operations/verification-commands.md), [`operations/engineering-handoff.md`](operations/engineering-handoff.md), and [`operations/handoff-acceptance-checklist.md`](operations/handoff-acceptance-checklist.md) — support, command selection, transfer procedure, and acceptance gate.
- [`operations/repository-maintenance-audit.md`](operations/repository-maintenance-audit.md) and [`evidence/repository-maintenance-closure-template.md`](evidence/repository-maintenance-closure-template.md) — workflow-based backend/cleanup inventory capture and durable closure evidence.
...
- [`maintenance/repository-cleanup-policy.md`](maintenance/repository-cleanup-policy.md), [`maintenance/repository-cleanup-baseline.json`](maintenance/repository-cleanup-baseline.json), and [`maintenance/repository-cleanup-evidence-template.md`](maintenance/repository-cleanup-evidence-template.md) — cleanup classification, approval, deletion safeguards, and retained evidence.

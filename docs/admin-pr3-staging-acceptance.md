...
- Runtime API/Web logs ถูก Redact Password, Secret, Bearer token และ JWT ก่อน Upload เป็น Artifact
...
รอบกู้คิวที่ค้างหลายชั่วโมงวันที่ 7 สิงหาคม 2026 ต้อง Rebase บน `main` ล่าสุดก่อน แล้ว Trigger ผ่าน Commit ปกติจาก Contents API เพื่อให้เกิด `pull_request:synchronize` จริง ผลจาก Head เก่าหรือ Synthetic merge commit เก่าห้ามนำมานับรวม

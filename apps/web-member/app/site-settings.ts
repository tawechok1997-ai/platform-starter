  ...
  banners: [
    {
      ...
      imageUrl: '/images/member-lobby/promotions/world-cup.jpeg',
      href: '/promotions',
      enabled: true,
    },
    {
      title: 'Daily Login',
      subtitle: 'กิจกรรมสมาชิก',
      imageUrl: '/images/member-lobby/promotions/daily-login.jpeg',
      href: '/promotions',
      enabled: true,
    },
    {
      title: 'กิจกรรมทายผล',
      subtitle: 'กิจกรรมโปรโมชั่น',
      imageUrl: '/images/member-lobby/promotions/lottery-event.jpeg',
      href: '/promotions',
      enabled: true,
    },
    {
      title: 'โปรโมชั่นสล็อต',
      subtitle: 'โปรโมชั่นแนะนำ',
      imageUrl: '/images/member-lobby/promotions/slot-promotion.jpeg',
      href: '/promotions',
      enabled: true,
    },
  ],
...
export function textSetting(
  ...
  group: keyof PublicSiteSettings,
  key: string,
  fallback: string,
) {
...
export function cmsContentSetting(settings: PublicSiteSettings): CmsContent {
  ...
  return {
    assets: Array.isArray((data as any).assets)
      ? (data as any).assets.map((item: any, index: number) => ({
    ...
    popup: {
      ...defaultCmsContent.popup,
      ...(data.popup && typeof data.popup === 'object' ? data.popup : {}),
    } as CmsContent['popup'],

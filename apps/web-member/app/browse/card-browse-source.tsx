...
export default function CardBrowseSource() {
  ...
  return (
    <>
      ...
      <style>{`
        main[data-source-game-category='card'] [data-source-filter-types] {
          height: 16px !important;
          min-height: 16px !important;
          padding: 0 !important;
        }

        main[data-source-game-category='card'] [data-source-provider-grid] {
          min-height: 40px !important;
        }

        main[data-source-game-category='card'] [data-source-filter-panel] button:disabled {

...
import { AdminGameTournamentController, PublicGameTournamentController } from './game-tournament.controller';
...
import { MemberGamePlatformController, PublicGameCatalogController } from './member-game-platform.controller';
...
import { PublicLiveMatchController, PublicLiveMatchService } from './public-live-match.controller';
...
@Module({
  ...
  controllers: [GamePlatformController, PublicGameCatalogController, PublicLiveMatchController, MemberGamePlatformController, MemberGameSessionController, MemberGameTransferController, AdminGameMoneyController, ProviderWebhookController, ProviderPresetController, AdapterTestController, GameTransferActionController, GameRoundDiagnosticsController, WalletLedgerReconciliationController, AdminGameTournamentController, PublicGameTournamentController],
  providers: [GamePlatformService, GameProviderQueryService, MemberGameCatalogService, PublicLiveMatchService, GamePlatformMoneyService, GamePlatformMonitoringService, GameRoundPersistenceService, GameRoundDiagnosticsRepository, GameRoundDiagnosticsService, GameSessionTokenService, GameSessionLifecycleService, WalletLedgerReconciliationService, ProviderWebhookService, WebhookLogQueryService, ProviderTransferCommandService, WalletMutationService, ProviderReconciliationQueryService, ProviderReconciliationCommandService, ProviderReconciliationAlertService, ProviderPresetService, AdapterTestService, GameTransferActionService, ProviderAdapterRegistry, GameTournamentService],
  exports: [GamePlatformService, GameProviderQueryService, MemberGameCatalogService, PublicLiveMatchService, GamePlatformMoneyService, GamePlatformMonitoringService, GameRoundPersistenceService, GameRoundDiagnosticsService, GameSessionTokenService, GameSessionLifecycleService, WalletLedgerReconciliationService, ProviderWebhookService, WebhookLogQueryService, ProviderTransferCommandService, WalletMutationService, ProviderReconciliationQueryService, ProviderReconciliationCommandService, ProviderReconciliationAlertService, ProviderPresetService, AdapterTestService, GameTransferActionService, ProviderAdapterRegistry, GameTournamentService],
})

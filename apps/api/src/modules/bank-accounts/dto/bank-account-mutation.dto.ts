...
export class ReceivingBankAccountDto extends CreateMemberBankAccountDto {
  ...
  @IsOptional()
  @IsIn(['ACTIVE', 'DISABLED', 'PENDING_REVIEW', 'REJECTED'])
...
export class UpdateReceivingBankAccountDto extends ReceivingBankAccountDto {}

export class ReviewMemberBankAccountDto {
  @IsIn(['ACTIVE', 'REJECTED', 'PENDING_REVIEW', 'DISABLED'])
  status!: 'ACTIVE' | 'REJECTED' | 'PENDING_REVIEW' | 'DISABLED';

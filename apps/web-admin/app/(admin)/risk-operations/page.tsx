...
const AREAS: RiskArea[] = [
  ...
  { title: 'Investigation', description: 'ติดตามเคสที่กำลังตรวจ ผู้รับผิดชอบ ความเร่งด่วน และรายการที่ค้างเกิน 24 ชั่วโมง', href: '/investigation', action: 'เปิด Investigation Queue', status: 'มีศูนย์เฉพาะแล้ว', tone: 'success' },
];

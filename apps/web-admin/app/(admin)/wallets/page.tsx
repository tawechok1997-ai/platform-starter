...
const walletsCopy: Record<AdminLocale, WalletsCopy> = {
  th: {
    eyebrow: 'การเงิน', title: 'กระเป๋าเงินสมาชิก', description: 'ค้นหา ตรวจยอด และปรับยอด', refresh: 'รีเฟรช', loading: 'กำลังโหลด...', totalWallets: 'กระเป๋าทั้งหมด', filteredWallets: 'กระเป๋าตามตัวกรอง', itemsOnPage: 'รายการหน้านี้', page: 'หน้า', availableOnPage: 'ยอดใช้ได้หน้านี้', lockedOnPage: 'ยอดล็อกหน้านี้', visibleOnly: 'รวมเฉพาะข้อมูลที่แสดง', unavailableBalance: 'ยอดที่ถูกกันไว้และยังใช้ไม่ได้',
  ...
  en: {
    eyebrow: 'Finance', title: 'Member wallets', description: 'Search, review, and adjust balances', refresh: 'Refresh', loading: 'Loading...', totalWallets: 'Total wallets', filteredWallets: 'Wallets matching the filter', itemsOnPage: 'Items on page', page: 'Page', availableOnPage: 'Available on page', lockedOnPage: 'Locked on page', visibleOnly: 'Visible data only', unavailableBalance: 'Funds reserved and unavailable for spending',

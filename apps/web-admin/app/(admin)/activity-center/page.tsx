...
import { AdminBadge, AdminButton, AdminCard, AdminDrawer, AdminEmpty, AdminLinkButton, AdminMetric, AdminMetricGrid, AdminNotice, AdminPage, AdminRow, AdminStack } from '../_components/admin-ui';
...
export default function ActivityCenterPage() {
  ...
  return <AdminPage eyebrow={t.eyebrow} title={t.title} description={t.description} actions={<AdminButton disabled={loading} onClick={() => void load()}>{loading ? t.loading : t.refresh}</AdminButton>}>
    <div className="admin-activity-center">
      ...
      <AdminDrawer open={Boolean(selected)} title={selected?.title ?? t.eventDetail} description={t.eventDetail} onClose={() => setSelected(null)}>
        {selected ? <AdminStack>

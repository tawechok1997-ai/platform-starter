...
export default function ExportsPage() {
  ...
  return <AdminPage eyebrow="Data Governance" title="Export Center" description="เลือกช่วงวันที่ ตรวจจำนวนแถว และยืนยันก่อนดาวน์โหลดข้อมูล">
    ...
    <AdminCard title="ประวัติการส่งออก" description={`แสดง ${MAX_HISTORY} งานล่าสุดบนอุปกรณ์นี้`} action={jobs.length > 0 ? <AdminButton size="compact" tone="ghost" disabled={locked} onClick={clearHistory}>ล้างประวัติ</AdminButton> : undefined}>

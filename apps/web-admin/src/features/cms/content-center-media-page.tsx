...
function LifecycleCard({ title, item, canUpdate, onLifecycle, onToggle, onRemove, onMoveUp, onMoveDown, children }: { title: string; item: { lifecycle: CmsLifecycle; enabled: boolean }; canUpdate: boolean; onLifecycle: (value: CmsLifecycle) => void; onToggle: () => void; onRemove?: () => void; onMoveUp?: () => void; onMoveDown?: () => void; children: ReactNode }) {
  return <article className="cms-editor-card">

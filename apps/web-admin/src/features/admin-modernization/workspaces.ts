...
export const ADMIN_WORKSPACES: readonly AdminWorkspace[] = [
  ...
  },
  {
    ...
    legacyPrefixes: [
      ...
      '/wallet-statement', '/wallet-analytics', '/reconciliation-center', '/reports', '/exports', '/ledgers', '/money-ops',
    ],
  ...
  },
  {
    ...
    legacyPrefixes: ['/members', '/member-insights', '/member-detail', '/bank-accounts', '/kyc', '/kyc-center', '/support', '/support-center'],
    mobilePattern: 'list-detail',
  },
  {
    id: 'risk-compliance',
  ...
  },
  {
    ...
    legacyPrefixes: [
      '/providers', '/provider-health', '/simple-game-settings', '/provider-setup-wizard', '/provider-presets',
      '/game-providers', '/provider-credentials', '/provider-adapters', '/provider-wallet-snapshots', '/webhook-logs',
      '/webhook-settlement', '/webhook-test', '/adapter-test', '/game-api-settings',
    ],
  ...
  },
  {
    ...
    legacyPrefixes: ['/access', '/admin-accounts', '/admin-roles', '/roles', '/admin-invitations', '/invitations', '/audit', '/audit-logs', '/security', '/anti-bot', '/profile'],
    mobilePattern: 'list-detail',
  },
  {
    id: 'settings',
